...
[![Source Code](http://img.shields.io/badge/source-workcode/wcrouter-blue.svg?style=flat-square)](https://github.com/denislumerk/wcrouter)
[![PHP from Packagist](https://img.shields.io/packagist/php-v/workcode/wcrouter.svg?style=flat-square)](https://packagist.org/packages/workcode/wcrouter)
[![Latest Version](https://img.shields.io/github/release/denislumerk/wcrouter.svg?style=flat-square)](https://github.com/denislumerk/wcrouter/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE)
[![Build](https://img.shields.io/scrutinizer/build/g/denislumerk/wcrouter.svg?style=flat-square)](https://scrutinizer-ci.com/g/denislumerk/wcrouter)
[![Quality Score](https://img.shields.io/scrutinizer/g/denislumerk/wcrouter.svg?style=flat-square)](https://scrutinizer-ci.com/g/denislumerk/wcrouter)
[![Total Downloads](https://img.shields.io/packagist/dt/workcode/wcrouter.svg?style=flat-square)](https://packagist.org/packages/workcode/wcrouter)
...
###### WorkCode is a set of small and optimized PHP components for common tasks. Held by Denis Lumerk and the UpInside team. With them you perform routine tasks with fewer lines, writing less and doing much more.

WorkCode é um conjunto de pequenos e otimizados componentes PHP para tarefas comuns. Mantido por Denis Lumerk e a equipe UpInside. Com eles você executa tarefas rotineiras com poucas linhas, escrevendo menos e fazendo muito mais.
...
```bash
composer require workcode/wcrouter
```
...
<form action="" method="POST">
    ...
    <input type="text" name="email" value="denislumerk@gmail.com"/>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://localhost/workcode/wcrouter/exemple/spoofing/",
  ...
  CURLOPT_POSTFIELDS => "first_name=Denis&last_name=Lumerk&email=denislumerk@gmail.com",
...
Please see [CONTRIBUTING](https://github.com/denislumerk/wcrouter/blob/master/CONTRIBUTING.md) for details.

## Support

###### Security: If you discover any security related issues, please email denislumerk@gmail.com instead of using the issue tracker.

Se você descobrir algum problema relacionado à segurança, envie um e-mail para denislumerk@gmail.com em vez de usar o rastreador de problemas.
...
- [All Contributors](https://github.com/denislumerk/wcrouter/contributors) (This Rock)

## License

The MIT License (MIT). Please see [License File](https://github.com/denislumerk/wcrouter/blob/master/LICENSE) for more information.